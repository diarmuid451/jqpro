...
public class ProdVO {
	...
	public ProdVO(String prod_id, String prod_name, String prod_lgu, String prod_buyer, int prod_cost, int prod_price,
			int prod_sale, String prod_outline, String prod_detail, int prod_totalstock, int prod_properstock,
			String prod_size, String prod_color, String prod_unit, int prod_qtyin, int prod_qtysale) {
		super();
